...
class Hero(models.Model):
    ...
    slug                =   AutoSlugField(populate_from='discription',max_length=255,unique=True,null=True, blank=True,)
...
class Slider(models.Model):
   ...
   slug                =   AutoSlugField(populate_from='subtitle',max_length=255,unique=True,null=True, blank=True,)
